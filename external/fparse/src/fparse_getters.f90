...
contains
    ...
    !          2. found
    !---------------------------------------------------------------------------
    subroutine get_string(schema, tree, block_name, key_name, value, &
        ounit, found)
        implicit none
    ...
    !          2. found
    !---------------------------------------------------------------------------
    subroutine get_integer(schema, tree, block_name, key_name, value, &
        ounit, found)
        implicit none
        type(schema_type), intent(in) :: schema
        type(input_tree_type), intent(in) :: tree
    ...
    !          2. found
    !---------------------------------------------------------------------------
    subroutine get_real(schema, tree, block_name, key_name, value, &
        ounit, found)
        implicit none
        type(schema_type), intent(in) :: schema
        type(input_tree_type), intent(in) :: tree
    ...
    !          2. found
    !---------------------------------------------------------------------------
    subroutine get_logical(schema, tree, block_name, key_name, value, &
        ounit, found)
        implicit none
        type(schema_type), intent(in) :: schema
        type(input_tree_type), intent(in) :: tree
    ...
    !          3. found
    !---------------------------------------------------------------------------
    subroutine get_integer_list(schema, tree, block_name, key_name, &
        values, nvalues, ounit, found)
        implicit none
        type(schema_type), intent(in) :: schema
        type(input_tree_type), intent(in) :: tree
        character(len=*), intent(in) :: block_name
    ...
    !          3. found
    !---------------------------------------------------------------------------
    subroutine get_real_list(schema, tree, block_name, key_name, &
        values, nvalues, ounit, found)
        implicit none
        type(schema_type), intent(in) :: schema
        type(input_tree_type), intent(in) :: tree
    ...
    !          3. found
    !---------------------------------------------------------------------------
    subroutine get_string_list(schema, tree, block_name, key_name, &
        values, nvalues, ounit, found)
        implicit none
        type(schema_type), intent(in) :: schema
        type(input_tree_type), intent(in) :: tree
    ...
    !          2. found
    !---------------------------------------------------------------------------
    subroutine get_raw_value(schema, tree, block_name, key_name, raw, &
        ounit, found)
        implicit none
        type(schema_type), intent(in) :: schema
        type(input_tree_type), intent(in) :: tree
